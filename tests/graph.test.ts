...
describe("Инициализация графа", () => {
	describe("Инициализация графа без препятствий", () => {
		it("должен корректно инициализировать граф", async () => {
	...
	describe("Установка препятствий", () => {
	...
	describe("Расчет стоимостей узлов", () => {
	...
	describe("Обработка ошибок", () => {
		it("должен выбросить ошибку, если стартовая точка находится на препятствии", async () => {
			...
			await expect(Graph.init(data)).rejects.toThrow(
				/находится на препятствии/,
			);
		});
